    ...
    if text.lower().startswith(('юни', 'uni')):
        try:
            ...
            response = chat.send_message("Ты чат бот в телеграмме по-имени Юни. Не пользуйся курсивом, жирным текстом "
                                         ...
                                         "теорверу https://t.me/+Vo0lhpLMHhMwMzZi ; Сегодня:" + datetime.now().strftime(
                "%Y-%m-%d %H:%M:%S") + "Сразу отвечай на смс далее:" + text)
            ...
            update.message.reply_text(
                'Извините, я совсем забыл о чем мы говорили... 😭 Можете, пожалуйста, повторить свой вопрос?')
